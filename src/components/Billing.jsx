import { apple, b1, google } from "../assets";
import styles, { layout } from "../style";

const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      <img src={b1} alt="billing" className="w-[100%] h-[100%] relative z-[5]" />
    ...
    <div className={layout.sectionInfo}>
      ...
      Intelligent SMS Retry <span className="text-gradient sm:block ">Algorithm</span>{" "}
      </h2>
