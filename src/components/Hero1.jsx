...
import { discount, hero_img, shield } from "../assets";
  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        Reach your customers globally with quick, scalable, and customizable email. Integrate our developer-friendly EMAIL API to send and receive email. Our distributed carrier network and intelligent routing ensure the highest delivery and lowest latency.        </p>
      </div>
